...
namespace MvcMovie.Controllers
{
    public class SuggestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Team,Owner,StartDate,Status")] Suggestion suggestion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Team,Owner,StartDate,Status")] Suggestion suggestion)
        {
            if (id != suggestion.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcMovieContext.Suggestion'  is null.");
            }
            var suggestion = await _context.Suggestion.FindAsync(id);
            if (suggestion != null)
            {
